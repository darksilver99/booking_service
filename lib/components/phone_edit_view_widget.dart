...
class PhoneEditViewWidget extends StatefulWidget {
  const PhoneEditViewWidget({super.key});

  @override
  State<PhoneEditViewWidget> createState() => _PhoneEditViewWidgetState();
}

class _PhoneEditViewWidgetState extends State<PhoneEditViewWidget> {
  late PhoneEditViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhoneEditViewModel());
