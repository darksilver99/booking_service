...
class _ServiceCategorySelectPageWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.rsList = await queryCategoryListRecordOnce(
      ...
      setState(() {
        ...
        _model.categoryList =
            _model.rsList!.toList().cast<CategoryListRecord>();
      });
    });
