...
class WaiteBookingDialogViewWidget extends StatefulWidget {
  ...
  State<WaiteBookingDialogViewWidget> createState() =>
      _WaiteBookingDialogViewWidgetState();
}

class _WaiteBookingDialogViewWidgetState
    extends State<WaiteBookingDialogViewWidget> {
  late WaiteBookingDialogViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WaiteBookingDialogViewModel());
  }
